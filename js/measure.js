	...
	Cesium.TerrainClipPlan = function() {
		...
		return n(e, [{
			...
			value: function(e) {
				...
				} else this._createBottomSurface(e.bottom_pos), this._createWellWall(e.bottom_pos, e.no_height_top)
			}
		}, {
			key: "_createWellWall",
			value: function(e, t) {
				var i = new Cesium.WellNoBottom({
					minimumArr: e,
					maximumArr: t
				});
				i = Cesium.WellNoBottom.createGeometry(i);
			...
			value: function(e) {
				if(e.length) {
					var t = new Cesium.CustomPlaneGeometry({
						pos_arr: e
					});
					t = Cesium.CustomPlaneGeometry.createGeometry(t);
